      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 bg-blue-50 p-8 rounded-lg">
          ...
          <p className="text-gray-700 italic mb-4">
            "Ola Otubu helped us buying our first home in LA! He was patient and attentive with our needs and wants. 
            He always made himself available to clarify any doubts or concerns throughout the process. 
            He made the entire process super easy and convenient. Definitely recommend Ola Otubu and his team!"
          </p>
