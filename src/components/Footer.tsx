  ...
  return (
    <footer className="bg-black text-white py-12 px-4">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
        ...
        {/* Explore Site */}
        <div>
          <h3 className="text-lg font-bold mb-4">EXPLORE SITE</h3>
          <ul className="space-y-2">
            <li><a href="/" className="text-gray-400 hover:text-white transition">HOME</a></li>
            <li><a href="/services" className="text-gray-400 hover:text-white transition">SERVICES</a></li>
            <li><a href="/reviews" className="text-gray-400 hover:text-white transition">REVIEWS</a></li>
            <li><a href="/faq" className="text-gray-400 hover:text-white transition">FAQ'S</a></li>
            <li><a href="/videos" className="text-gray-400 hover:text-white transition">VIDEOS</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <input 
            ...
            className="w-full px-4 py-2 mb-3 rounded bg-transparent border border-gray-600 text-white text-sm"
          />
          <input 
            type="tel" 
